...
= 1.3.7 — 2024-10-15 =
- Fixed: Cross-site scripting (XSS) vulnerability for all widgets with SVG; Thanks to Patchstack team
- Fixed: Cross-site scripting (XSS) vulnerability for all widgets with SVG; Thanks to Wordfence team, Thanks to [Francesco Carlucci](https://francescocarlucci.com/)
