 ...
 * @since 1.0.0
 */
class BW_List extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'list_title' => __( 'Item content #1', 'bw' ),
						'icon_widget' => [
                            'value' => 'eicon eicon-check',
                        ],
					],
					[
                        'list_title' => __( 'Item content #2', 'bw' ),
						'icon_widget' => [
                            'value' => 'eicon eicon-check',
                        ],
					],
