...
echo '<div class="wrap bw-box-backend">';
    ...
    echo '<div class="card">';
        ...
        echo '<p>Dsgn is a simple way to start a WordPress website that you can begin to easily, quickly, and accessible. You will see many adaptations soon, like other Elementor Add-Ons and compatible WordPress Themes.</p>';
