...
echo '<div class="wrap bw-box-backend">';
    ...
    echo '<div class="card">';
        ...
        echo '<a href="https://modernaweb.net/dsgn/" target="_blank" class="bw-img"><img class="bw-banner" src="'. esc_url( BLACK_WIDGETS_PLUGIN_URL ) . 'assets/admin/img/dsgn-in-black-widgets.jpg'.'" /></a>';
    echo '</div>';
    echo '<div class="card">';
