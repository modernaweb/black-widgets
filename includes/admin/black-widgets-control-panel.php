...
echo '<div class="wrap bw-box-backend">';
    ...
    echo '<h1 class="bw-backend-heading">Hello '. esc_html( $current_user->nickname ).',</h1>';
    echo '<div class="card">';
        ...
        echo '<a href="https://modernaweb.net/dsgn/" target="_blank" class="bw-img"><img class="bw-banner" src="'. esc_url( BLACK_WIDGETS_PLUGIN_URL. 'assets/admin/img/dsgn-in-black-widgets.jpg' ) .'" /></a>'; // phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
    echo '</div>';
    echo '<div class="card">';
