 ...
 * @since 1.0.0
 */
class Sentence extends \Elementor\Widget_Base {

    public function __construct( $data = [], $args = null ) {
        parent::__construct( $data, $args );
        wp_register_style( 'black-widgets-sentence', BLACK_WIDGETS_PLUGIN_URL . 'assets/css/sentence.css', [], BLACK_WIDGETS_VERSION );
    }
...
class_alias('Modernaweb\BlackWidgets\Widgets\Sentence', 'Black_Widgets\BLACK_WIDGETS_Sentence');
