...
class BlockQuote extends \Elementor\Widget_Base {
    ...
    public function __construct( $data = [], $args = null ) {
        ...
        wp_register_style( 'black-widgets-block-quote', BLACK_WIDGETS_PLUGIN_URL . 'assets/css/block-quote.css', [], BLACK_WIDGETS_VERSION );
    }
    ...
    public function get_style_depends() {
        return [ 'black-widgets-block-quote' ];
    }
			...
			echo '<div class="bw-icon-into">';
				switch ($type) {
					...
					case 'icon':
						...
						break;
					default:
						echo '<img src="' . Group_Control_Image_Size::get_attachment_image_src( $settings['image_widget']['id'], 'thumbnail', $settings ) . '" class="bw-img-quote">'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						break;
				}
			echo '</div>';
...
class_alias('Modernaweb\BlackWidgets\Widgets\BlockQuote', 'Black_Widgets\BLACK_WIDGETS_Block_Quote');
