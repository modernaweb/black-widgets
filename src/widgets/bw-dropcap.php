 ...
 * @since 1.0.0
 */
class Dropcap extends \Elementor\Widget_Base {

    public function __construct( $data = [], $args = null ) {
        parent::__construct( $data, $args );
        wp_register_style( 'black-widgets-dropcap', BLACK_WIDGETS_PLUGIN_URL . 'assets/css/dropcap.css', [], BLACK_WIDGETS_VERSION );
    }
...
class_alias('Modernaweb\BlackWidgets\Widgets\Dropcap', 'Black_Widgets\BLACK_WIDGETS_Dropcap');
