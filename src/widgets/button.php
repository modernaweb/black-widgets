...
class Button extends \Elementor\Widget_Base {
    ...
    public function __construct( $data = [], $args = null ) {
        ...
        wp_register_script( 'black-widgets-button', BLACK_WIDGETS_PLUGIN_URL . 'assets/js/button.js', [ 'jquery', 'black-widgets-tilt' ], BLACK_WIDGETS_VERSION );
    }
			...
			switch ($type) {
				case 'modern':
					switch ($modern_type) {
						...
						break;
						default:
							echo '<a href="' . esc_url( $settings['website_link']['url'] ) . '"' . $target . $nofollow . ' class="bw-btn">' . $text . '</a>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						break;
					}
				break;
				case 'noise':
				...
				case 'abstract':
					switch ($abstract_type) {
						...
						break;
						case 'a-2':
                            echo '<a href="' . esc_url( $settings['website_link']['url'] ) . '"' . $target . $nofollow . ' class="bw-btn"><div class="btx-a1" id="' . $script_id . '" data-text="' . esc_attr( $text ) . '">' . $text . '</div></a>';
						break;
						default:
							echo '<a href="' . esc_url( $settings['website_link']['url'] ) . '"' . $target . $nofollow . ' class="bw-btn">' . $text . '</a>';
						break;
