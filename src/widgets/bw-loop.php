 ...
 * @since 1.0.0
 */
class Loop extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Black Loop', 'black-widgets' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'post_type',
			[
				'label' => esc_html__( 'Alert Text', 'black-widgets' ),
				'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( 'post', 'black-widgets' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'style_2' 	=> esc_html__( 'Style 2', 'black-widgets' ),
					'style_3' 	=> esc_html__( 'Style 3', 'black-widgets' ),
					'style_4' 	=> esc_html__( 'Style 4', 'black-widgets' ),
				],
		...
		$this->add_control(
			'enable_icon_widget',
			[
				'label' 		=> esc_html__( 'Enable Icon', 'black-widgets' ),
...
class_alias('Modernaweb\BlackWidgets\Widgets\Loop', 'Black_Widgets\BLACK_WIDGETS_Loop');
