 ...
 * @since 1.0.0
 */
class Alert extends \Elementor\Widget_Base {

    public function __construct( $data = [], $args = null ) {
        parent::__construct( $data, $args );
        wp_register_style( 'black-widgets-alert', BLACK_WIDGETS_PLUGIN_URL . 'assets/css/alert.css', [], BLACK_WIDGETS_VERSION );
    }
...
class_alias('Modernaweb\BlackWidgets\Widgets\Alert', 'Black_Widgets\BLACK_WIDGETS_Alert');
