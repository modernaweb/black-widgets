 ...
 * @since 1.0.0
 */
class Box extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Black Box', 'black-widgets' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'bw-style-1',
                'options' => [
                    'bw-style-1' => esc_html__( 'Type 1', 'black-widgets' ),
                    'bw-style-2' => esc_html__( 'Type 2', 'black-widgets' ),
                ],
        ...
        $this->add_control(
            'box_link',
            [
                'label' => esc_html__( 'Box Link', 'black-widgets' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'no',
                'options' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Clean & Solid', 'black-widgets' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Type your title here', 'black-widgets' ),
                'default' => esc_html__( 'Development, Design, and E-Commerce', 'black-widgets' ),
                'description' => esc_html__( 'You can use all other HTML tags into the title field e.g. code, mark, abbr, blockquote and  ...', 'black-widgets' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .bw-hover-box .bw-title-box .bw-title' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bw-hover-box .bw-content-box .bw-title, {{WRAPPER}} .bw-hover-box .bw-title-box .bw-title',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .bw-hover-box .bw-title-box .bw-description' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bw-hover-box .bw-content-box .bw-description, {{WRAPPER}} .bw-hover-box .bw-title-box .bw-description',
            ]
        );
        ...
        $this->start_controls_section(
            'style2_link_section',
            [
                'label' => esc_html__( 'Overlay Style', 'black-widgets' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition'  => [
                    'widget_type' => [
                        'bw-style-2',
...
class_alias('Modernaweb\BlackWidgets\Widgets\Box', 'Black_Widgets\BLACK_WIDGETS_Box');
